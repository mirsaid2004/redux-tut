...
const navList = [
  { title: 'Posts', path: '/lesson/performance-optimizations' },
  {
    title: 'Create Post',
    path: '/lesson/performance-optimizations/create-post',
  },
  { title: 'Users', path: '/lesson/performance-optimizations/users' },
];
